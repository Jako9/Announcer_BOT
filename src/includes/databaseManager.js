...
module.exports = {
    ...
    saveServer: function(server, id, callback){
        ...
        let q = "UPDATE server SET name='"+ name + "',avatar='" + avatar +"', rolle="+ rolle +", prefix="+ prefix + ", volume="+ volume +", standartRole="+ standartRole + ", channelReact="+ channelReact +" WHERE guildID=" + id;
